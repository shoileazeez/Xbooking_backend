...
class TestBookingListImageUrl(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.user = User.objects.create(full_name="List Test", email="listtest@example.com", is_active=True)
    ...
    def test_list_bookings_includes_image_url(self):
        url = reverse('booking:list_bookings')
        ...
        self.assertEqual(results[0]['image_url'], self.space.image_url)
